...
class PredictionHints
  ...
  @@hints = Hash[
      Prediction.category_known_number_of_categories => [ "Your are probably interested in clustering because you selected category prediction" ],
      Prediction.category_unknown_number_of_categories => [ "Your are probably interested in classification because you selected category prediction" ],
